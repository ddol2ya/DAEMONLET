...
const errors: Record<ChatError, [string, string]> = {
  ...
  CHAT_RUNTIME_UNSUPPORTED: ["검증된 공식 macOS arm64 CLI를 연결 설정에서 선택해 주세요. 저장된 custom 실행파일은 자동 사용하거나 교체하지 않습니다.", "Select a verified official macOS arm64 CLI in connection settings. Saved custom executables are not automatically used or replaced."],
