...
우클릭·트레이의 **캐릭터와 대화**로 바로 접근합니다. 새 설치는 기본 ON이며 기존 사용자의 OFF 선택은 보존합니다. 공식 CLI·로그인 준비를 확인하고 부모 대화를 직접 선택한 뒤 질문합니다. 첫 보내기에서 맥락·선택 파일 전달과 사용량에 동의하며, 보내기 전 모델 생성은 없습니다. 화면 적용에 성공한 기존 캐릭터팩의 페르소나를 사용합니다.
