...
export default {
  packagerConfig: {
    ...
    extraResource: ["dist-electron/app-update.yml", "dist-electron/codex", "dist-electron/native", "dist-notices/licenses", ...((process.env.PET_BUILD_PLATFORM ?? process.platform) === "darwin" ? ["electron/assets/locales/en.lproj", "electron/assets/locales/ko.lproj"] : [])],
