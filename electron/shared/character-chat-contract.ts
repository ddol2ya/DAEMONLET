...
export type ChatMessage = {id:string;role:'user'|'assistant';text:string;status:'complete'|'streaming'|'stopped'|'error';createdAt:string;binding?:GenerationBinding}
