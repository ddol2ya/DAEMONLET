...
const actions={'upgrade-chat':'scripts/characters/upgrade-pack-chat.mjs','publish-update-packs':'scripts/characters/publish-update-packs.mjs','add-update-source':'scripts/characters/add-update-source.mjs','create-update-feed':'scripts/characters/create-update-feed.mjs',motion:'scripts/characters/author-motion.mjs',review:'scripts/characters/production-review.mjs','validate-persona':'scripts/characters/validate-persona.mjs','upgrade-persona':'scripts/characters/upgrade-pack-persona.mjs',decompose:'scripts/run-seethrough.mjs',build:'scripts/characters/build-source-models.py',finish:'scripts/characters/finish-source-models.py',capture:'scripts/characters/capture-source-models.mjs',verify:'scripts/characters/verify-independent.mjs',payload:'scripts/characters/build-independent-payload.mjs',export:'scripts/characters/export-pack.mjs'}
