...
Status: **b4dbbb7 fixes and scoped production verification complete; new Mac notarization awaiting file-specific approval. Draft, no merge or public release**. App version remains **0.7.2**. Candidate results are scoped to their embedded source commit. Failed candidates and review profiles remain evidence.
