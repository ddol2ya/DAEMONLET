...
PR #17의 캐릭터 대화 후보는 Windows native의 실제 계정·같은 home·ACL·설치 검증 전에는
연결을 차단하고 준비 안내를 표시합니다. 기존 데스크톱 감지·제어·받아쓰기와 별도 범위입니다.
[사이드챗 호환성](side-chat.md)과 후보 보고서의 `WINDOWS_NOT_RUN`을 확인하세요.
