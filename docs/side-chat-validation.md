...
- `npm run typecheck`: PASS. Full suite: **148 files, 1,496 passed, 5 skipped**. `npm run test:side-chat`: **50 passed**. Extended side-chat/persona/bubble/IPC/window selection: **74 passed**.
